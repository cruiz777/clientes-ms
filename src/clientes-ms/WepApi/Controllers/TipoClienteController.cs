...
namespace clientes_ms.WebApi.Controllers
{
    ...
    public class TipoClienteController : ControllerBase
    {
        ...
        {
            var result = await _mediator.Send(new GetTipoClienteByIdQuery(id));
            return Ok(result);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] TipoClienteRequest request)
        {
            var result = await _mediator.Send(new CreateTipoClienteCommand(request));
            return Ok(result);
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(long id, [FromBody] TipoClienteRequest request)
        {
            var result = await _mediator.Send(new UpdateTipoClienteCommand(id, request));
            return Ok(result);
        }
        ...
        {
            var result = await _mediator.Send(new DeleteTipoClienteCommand(id));
            return Ok(result);
        }
